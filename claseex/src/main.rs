...
fn main() {
    ...
    while !rl.window_should_close() {
        ...
        if (time - last_render_time) > render_interval {
        ...
        d.draw_text("Rendering in progress...", 10, 40, 14, Color::LIGHTGRAY);

        // Controles
        d.draw_text("Controls:", 10, height - 120, 16, Color::WHITE);
        d.draw_text("- Click + Drag: Rotate camera", 10, height - 100, 14, Color::LIGHTGRAY);
        d.draw_text("- Mouse Wheel: Zoom", 10, height - 80, 14, Color::LIGHTGRAY);
        d.draw_text("- WASD: Manual control", 10, height - 60, 14, Color::LIGHTGRAY);
        d.draw_text("- SPACE: Auto-rotate", 10, height - 40, 14, Color::LIGHTGRAY);
